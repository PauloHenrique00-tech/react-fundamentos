...
O useEffect é um hook do Reacr usado para executar ou lidar com
efeitos colaterais em componentes funcionais.
...
- Routes e Route: definem as rotas e caminhos associados aos componentes/
  páginas
- Link: componente especial para navegação entre as páginas através das rotas.
  Deve ser usado no lugar da tag <a> (somente para links relativos/internos)
